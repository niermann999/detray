...
GTEST_TEST(detray_coordinates, cylindrical2D) {
    ...
    const point3 local = c2.global_to_local_3D(trf, global1, {});
...
GTEST_TEST(detray_coordinates, concentric_cylindrical2D) {
    ...
    const concentric_cylindrical2D<transform3> c2;
