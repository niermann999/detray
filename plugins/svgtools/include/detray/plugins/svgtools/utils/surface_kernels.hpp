...
struct link_start_getter {
    ...
    auto inline link_start(const detray::mask<detray::ring2D>& mask,
        ...
        using point_t = typename mask_t::point2_t;
        ...
        return mask.to_global_frame(transform, point_t{r, phi});
    }
    ...
    auto inline link_start(const detray::mask<shape_t>& mask,
        ...
        return mask.to_global_frame(transform, point_t{r * phi, z});
    }
    ...
    auto inline link_start(const detray::mask<detray::cylinder3D>& mask,
        ...
        using mask_t = detray::mask<shape_t>;
        using point_t = typename mask_t::point3_t;
        using scalar_t = typename mask_t::scalar_type;
