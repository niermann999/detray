...
#Turn on the correct setting for the __cplusplus macro with MSVC.
    if ("${CMAKE_CXX_COMPILER_ID}" MATCHES
        "MSVC") detray_add_flag(CMAKE_CXX_FLAGS "/Zc:__cplusplus") endif()

#Respect infinity expressions for IntelLLVM
        if ("${CMAKE_CXX_COMPILER_ID}" MATCHES
            "IntelLLVM") detray_add_flag(CMAKE_CXX_FLAGS
                                         "-fhonor-infinities") endif()

            if ("${CMAKE_CXX_COMPILER_ID}" MATCHES
                "Clang") detray_add_flag(CMAKE_CXX_FLAGS
                                         "-Wshorten-64-to-32") endif()
...
#Basic flags for all build modes.
                    detray_add_flag(CMAKE_CXX_FLAGS "-Wall") detray_add_flag(
                        CMAKE_CXX_FLAGS
                        "-Wextra") detray_add_flag(CMAKE_CXX_FLAGS "-Wshadow")
                        detray_add_flag(CMAKE_CXX_FLAGS
...
#No implicit single to double conversions from floating point literals
                                detray_add_flag(CMAKE_CXX_FLAGS_DEBUG
                                                "-Wconversion")
