...
struct local_coordinate {
    ...
    // Transform type
    using transform3_type = typename frame_t::transform3_type;
    // Scalar type
    ...
    using local_frame_type = detail::coordinate_base<frame_t>;
    ...
    inline point3 global_to_local(const transform3_type& trf3, const point3& p,
        ...
        return local_frame_type{}.global_to_local(trf3, p, d);
    }
    ...
    DETRAY_HOST_DEVICE inline point3 local_to_global(
        ...
        return local_frame_type{}.local_to_global(trf3, p);
    }
    ...
    DETRAY_HOST_DEVICE inline point3 bound_local_to_global(
        ...
        const vector3& d) const {
        return local_frame_type{}.bound_local_to_global(trf3, mask, p, d);
    }

    /// @returns the normal vector
    DETRAY_HOST_DEVICE inline vector3 normal(const transform3_type& trf3,
                                             const point3& p = {}) const {
        return local_frame_type{}.normal(trf3, p);
    }
    ...
    inline bound_vector free_to_bound_vector(
        ...
        const point3 local = local_frame_type().global_to_local(trf3, pos, dir);
    ...
    DETRAY_HOST_DEVICE inline free_vector bound_to_free_vector(
        ...
        const auto pos = local_frame_type().bound_local_to_global(
    ...
    DETRAY_HOST_DEVICE inline bound_to_free_matrix bound_to_free_jacobian(
        ...
        local_frame_type().set_bound_pos_to_free_pos_derivative(jac_to_global,
                                                                trf3, pos, dir);
        ...
        local_frame_type().set_bound_angle_to_free_pos_derivative(
    ...
    DETRAY_HOST_DEVICE inline free_to_bound_matrix free_to_bound_jacobian(
        ...
        local_frame_type().set_free_pos_to_bound_pos_derivative(jac_to_local,
                                                                trf3, pos, dir);
    ...
    DETRAY_HOST_DEVICE inline free_matrix path_correction(
        ...
        const scalar dqopds, const transform3_type& trf3) const {

        free_to_path_matrix path_derivative =
            local_frame_type().path_derivative(trf3, pos, dir, dtds);
